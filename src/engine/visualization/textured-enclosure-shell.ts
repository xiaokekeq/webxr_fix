...
export class TexturedEnclosureShell {
	...
	register(result: EnclosureShellBuildResult, reason: string): void { this.buildCount += 1; this.lastBuildReason = reason; result.root.visible = false; result.root.userData.enclosureMaterialSources = result.materialSources; }
