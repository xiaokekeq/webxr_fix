...
defineProps<{ viewMode: UndergroundViewMode; materialMode: UndergroundMaterialMode; inspectionTool: UndergroundInspectionTool; sectionMode: SectionCutPlaneMode; error: string }>();
